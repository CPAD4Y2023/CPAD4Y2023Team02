            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...List.generate(
                        onbording_data.length,
                        (index) => Padding(
                            padding: const EdgeInsets.only(right: 4),
                            child:
                                lineIndicator(isActive: index == _pageIndex))),
                    const Spacer(),
                    SizedBox(
                        height: 60,
                        width: 140,
                        child: OnBordingButton(
...
final List<OnBoard> onbording_data = [
  OnBoard(
      ...
      title: "Recycle",
      description:
          "Recycling made as easy as ordering pizza. We Strongly believe nothing is waste, Everything has a right place."),
  OnBoard(
        ...
        children: [
          ...
          Align(
            ...
            child: Text(
              title,
              style: TextStyle(
                  color: Color(int.parse("0xff646464")), fontSize: 22),
            ),
          ),
