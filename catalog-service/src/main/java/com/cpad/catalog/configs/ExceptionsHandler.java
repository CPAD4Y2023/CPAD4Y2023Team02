...
public class ExceptionsHandler {
    ...
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(MethodArgumentNotValidException ex) {
    ...
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(PermissionException ex, WebRequest request) {
        return CatalogServiceResponse.forbidden(ex.getMessage());
    }

    @ExceptionHandler(ForbiddenException.class)
    @ResponseStatus(code = HttpStatus.FORBIDDEN)
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(ForbiddenException ex, WebRequest request) {
        return CatalogServiceResponse.forbidden(ex.getMessage());
    }

    @ExceptionHandler(NotFoundException.class)
    @ResponseStatus(code = HttpStatus.NOT_FOUND)
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(NotFoundException ex, WebRequest request) {
        return CatalogServiceResponse.notFound(ex.getMessage());
    }

    @ExceptionHandler(UnauthorizedException.class)
    @ResponseStatus(code = HttpStatus.UNAUTHORIZED)
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(UnauthorizedException ex, WebRequest request) {
        return CatalogServiceResponse.unauthorized(ex.getMessage());
    }

    @ExceptionHandler(BadRequestException.class)
    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(BadRequestException ex, WebRequest request) {
        return CatalogServiceResponse.badRequest(ex.getMessage());
    }

    @ExceptionHandler(InternalServerException.class)
    @ResponseStatus(code = HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(InternalServerException ex, WebRequest request) {
        return CatalogServiceResponse.internalServerError(ex.getMessage());
    }

    @ExceptionHandler(ServiceCatalogException.class)
    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    public ResponseEntity<CatalogServiceResponse<String>> handleAllExceptions(ServiceCatalogException ex, WebRequest request) {
        return CatalogServiceResponse.badRequest(ex.getMessage());
    }
}
