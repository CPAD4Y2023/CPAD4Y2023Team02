...
public interface ResponseConstants {
  ...
  class ResponseMessages {
    ...
    public static final String NON_AUTHORITATIVE_INFORMATION_MESSAGE =
    ...
    public static final String MOVED_TEMPORARILY_MESSAGE = " movedTemporarily.";
    public static final String SEE_OTHER_MESSAGE = " seeOther.";
    public static final String NOT_MODIFIED_MESSAGE = " notModified.";
    public static final String USE_PROXY_MESSAGE = " useProxy.";
    ...
    public static final String PROXY_AUTHENTICATION_REQUIRED_MESSAGE =
    ...
    public static final String REQUEST_ENTITY_TOO_LARGE_MESSAGE = " requestEntityTooLarge.";
    public static final String URI_TOO_LONG_MESSAGE = " uriTooLong.";
    public static final String REQUEST_URI_TOO_LONG_MESSAGE = " requestUriTooLong.";
    public static final String UNSUPPORTED_MEDIA_TYPE_MESSAGE = " unsupportedMediaType.";
    public static final String REQUESTED_RANGE_NOT_SATISFIABLE_MESSAGE =
        " requestedRangeNotSatisfiable.";
    public static final String EXPECTATION_FAILED_MESSAGE = " expectationFailed.";
    public static final String I_AM_A_TEAPOT_MESSAGE = " iAmATeapot.";
    public static final String INSUFFICIENT_SPACE_ON_RESOURCE_MESSAGE =
        " insufficientSpaceOnResource.";
    public static final String METHOD_FAILURE_MESSAGE = " methodFailure.";
    public static final String DESTINATION_LOCKED_MESSAGE = " destinationLocked.";
    ...
    public static final String REQUEST_HEADER_FIELDS_TOO_LARGE_MESSAGE =
        " requestHeaderFieldsTooLarge.";
    public static final String UNAVAILABLE_FOR_LEGAL_REASONS_MESSAGE =
